...
public class MyDate {
    ...
    private static int[] nonLeapYearMonth = {0, 3, 3, 6, 1, 4, 6, 2, 5, 0, 3, 5};    
    private static int[] leapYearMonth = {6, 2, 3, 6, 1, 4, 6, 2, 5, 0, 3, 5};
    ...
    public static int getDayOfWeek(int year, int month, int day)
    {
        ...
        int magicMonthNumber = isLeapYear(year) ? leapYearMonth[month-1] : nonLeapYearMonth[month-1];
